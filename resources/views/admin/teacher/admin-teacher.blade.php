    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden"
                ...
                {{-- Menu Table --}}
                <x-admin.menu-table button-label="Add Teacher" on-click="openAddModal = true" />
                        ...
                        <tbody>
                            @forelse ($teachers as $teacher)
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td class="px-4 py-3">{{ $teachers->firstItem() + $loop->index }}</td>
                                    ...
                                    <td class="px-4 py-3">{{ Str::limit($teacher->address, 30) }}</td>
                                    <td class="px-4 py-3">
                                        <div class="flex items-center justify-center space-x-2">
                                            {{-- Edit Button --}}
                                            <button 
                                                @click="openEditModal = true; editTeacherId = {{ $teacher->id }}"
                                            ...
                                            {{-- Delete Button --}}
                                            <button 
                                                @click="deleteUrl = '{{ route('admin.teacher.destroy', $teacher->id) }}'; openDeleteModal = true"
                ...
                @foreach ($teachers as $teacher)
                    <div x-show="openEditModal && editTeacherId === {{ $teacher->id }}" 
                         x-transition
                ...
                <div x-show="openDeleteModal" 
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg w-full max-w-md p-6 relative">
                        ...
                        <div class="text-center">
                            ...
                            <p class="mb-4 text-gray-500 dark:text-gray-300">Are you sure you want to delete this teacher? This action cannot be undone.</p>
