    ...
    <nav class="bg-gray-800">
                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <el-dropdown class="relative ml-3">
                            <button
                                ...
                                <img src="https://media.licdn.com/dms/image/v2/C5603AQFY9FllXtOcPg/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1612771993568?e=2147483647&v=beta&t=sTar5VRnBNT-xulMBDNd_fknAkALS_zT3dMcbC7HR3c"
        ...
        <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                ...
                <a href="/home" aria-current="page"
                    class="{{ request()->is('home') ? 'block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">Home</a>
                <a href="/kontak"
                    class="{{ request()->is('kontak') ? 'block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">Contact</a>
                <a href="/profil"
                    class="{{ request()->is('profil') ? 'block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">Profil</a>
                <a href="/classrooms"
                    class="{{ request()->is('classrooms') ? 'block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">Classrooms</a>
            </div>
